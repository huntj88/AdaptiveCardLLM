...
data class HostConfig(
    ...
    companion object {
        ...
        fun deserialize(json: JSONObject): HostConfig {
            ...
            result.factSet = FactSetConfig.deserialize(json.optJSONObject("factSet") ?: JSONObject(), result.factSet)
            result.fontSizes = FontSizesConfig.deserialize(json.optJSONObject("fontSizes") ?: JSONObject(), result.fontSizes)
            result.fontWeights = FontWeightsConfig.deserialize(json.optJSONObject("fontWeights") ?: JSONObject(), result.fontWeights)
            result.fontTypes = FontTypesDefinition.deserialize(json.optJSONObject("fontTypes") ?: JSONObject(), result.fontTypes)
            result.containerStyles = ContainerStylesDefinition.deserialize(json.optJSONObject("containerStyles") ?: JSONObject(), result.containerStyles)
            result.image = ImageConfig.deserialize(json.optJSONObject("image") ?: JSONObject(), result.image)
            result.imageSet = ImageSetConfig.deserialize(json.optJSONObject("imageSet") ?: JSONObject(), result.imageSet)
            result.imageSizes = ImageSizesConfig.deserialize(json.optJSONObject("imageSizes") ?: JSONObject(), result.imageSizes)
            result.separator = SeparatorConfig.deserialize(json.optJSONObject("separator") ?: JSONObject(), result.separator)
            result.spacing = SpacingConfig.deserialize(json.optJSONObject("spacing") ?: JSONObject(), result.spacing)
            result.adaptiveCard = AdaptiveCardConfig.deserialize(json.optJSONObject("adaptiveCard") ?: JSONObject(), result.adaptiveCard)
            result.actions = ActionsConfig.deserialize(json.optJSONObject("actions") ?: JSONObject(), result.actions)
            result.media = MediaConfig.deserialize(json.optJSONObject("media") ?: JSONObject(), result.media)
            result.hostWidth = HostWidthConfig.deserialize(json.optJSONObject("hostWidth") ?: JSONObject(), result.hostWidth)
            result.inputs = InputsConfig.deserialize(json.optJSONObject("inputs") ?: JSONObject(), result.inputs)
            result.textBlock = TextBlockConfig.deserialize(json.optJSONObject("textBlock") ?: JSONObject(), result.textBlock)
            result.textStyles = TextStylesConfig.deserialize(json.optJSONObject("textStyles") ?: JSONObject(), result.textStyles)
            result.ratingLabelConfig = RatingElementConfig.deserialize(json.optJSONObject("ratingLabelConfig") ?: JSONObject(), result.ratingLabelConfig)
            result.ratingInputConfig = RatingElementConfig.deserialize(json.optJSONObject("ratingInputConfig") ?: JSONObject(), result.ratingInputConfig)
            result.table = TableConfig.deserialize(json.optJSONObject("table") ?: JSONObject(), result.table)
            result.borderWidth = json.optJSONObject("borderWidth")
            result.cornerRadius = json.optJSONObject("cornerRadius")
            result.compoundButtonConfig = CompoundButtonConfig.deserialize(json.optJSONObject("compoundButtonConfig") ?: JSONObject(), result.compoundButtonConfig)
            return result
        }
    }
}
...
data class FactSetConfig(
    ...
    companion object {
        fun deserialize(json: JSONObject, defaultValue: FactSetConfig): FactSetConfig {
            ...
            result.title = FactSetTextConfig.deserialize(json.optJSONObject("title") ?: JSONObject(), defaultValue.title)
            result.value = FactSetTextConfig.deserialize(json.optJSONObject("value") ?: JSONObject(), defaultValue.value)
            return result
        }
    }
}
...
data class FontTypesDefinition(
    ...
    companion object {
        fun deserialize(json: JSONObject, defaultValue: FontTypesDefinition): FontTypesDefinition {
            ...
            result.defaultFontType = FontTypeDefinition.deserialize(json.optJSONObject("defaultFontType") ?: JSONObject(), defaultValue.defaultFontType)
            result.monospaceFontType = FontTypeDefinition.deserialize(json.optJSONObject("monospaceFontType") ?: JSONObject(), defaultValue.monospaceFontType)
            return result
        }
    }
}
...
data class FontTypeDefinition(
    ...
    companion object {
        fun deserialize(json: JSONObject, defaultValue: FontTypeDefinition): FontTypeDefinition {
            ...
            result.fontSizes = FontSizesConfig.deserialize(json.optJSONObject("fontSizes") ?: JSONObject(), defaultValue.fontSizes)
            result.fontWeights = FontWeightsConfig.deserialize(json.optJSONObject("fontWeights") ?: JSONObject(), defaultValue.fontWeights)
            return result
        }
    }
}
...
data class ContainerStylesDefinition(
    ...
    companion object {
        fun deserialize(json: JSONObject, defaultValue: ContainerStylesDefinition): ContainerStylesDefinition {
            ...
            result.defaultPalette = ContainerStyleDefinition.deserialize(json.optJSONObject("defaultPalette") ?: JSONObject(), defaultValue.defaultPalette)
            result.emphasisPalette = ContainerStyleDefinition.deserialize(json.optJSONObject("emphasisPalette") ?: JSONObject(), defaultValue.emphasisPalette)
            result.goodPalette = ContainerStyleDefinition.deserialize(json.optJSONObject("goodPalette") ?: JSONObject(), defaultValue.goodPalette)
            result.attentionPalette = ContainerStyleDefinition.deserialize(json.optJSONObject("attentionPalette") ?: JSONObject(), defaultValue.attentionPalette)
            result.warningPalette = ContainerStyleDefinition.deserialize(json.optJSONObject("warningPalette") ?: JSONObject(), defaultValue.warningPalette)
            result.accentPalette = ContainerStyleDefinition.deserialize(json.optJSONObject("accentPalette") ?: JSONObject(), defaultValue.accentPalette)
            return result
        }
    }
}
...
data class ContainerStyleDefinition(
    ...
    companion object {
        fun deserialize(json: JSONObject, defaultValue: ContainerStyleDefinition): ContainerStyleDefinition {
            ...
            result.foregroundColors = ColorsConfig.deserialize(json.optJSONObject("foregroundColors") ?: JSONObject(), defaultValue.foregroundColors)
            return result
        }
    }
}
...
data class ColorsConfig(
    ...
    companion object {
        fun deserialize(json: JSONObject, defaultValue: ColorsConfig): ColorsConfig {
            ...
            result.defaultColor = ColorConfig.deserialize(json.optJSONObject("defaultColor") ?: JSONObject(), defaultValue.defaultColor)
            result.accent = ColorConfig.deserialize(json.optJSONObject("accent") ?: JSONObject(), defaultValue.accent)
            result.dark = ColorConfig.deserialize(json.optJSONObject("dark") ?: JSONObject(), defaultValue.dark)
            result.light = ColorConfig.deserialize(json.optJSONObject("light") ?: JSONObject(), defaultValue.light)
            result.good = ColorConfig.deserialize(json.optJSONObject("good") ?: JSONObject(), defaultValue.good)
            result.warning = ColorConfig.deserialize(json.optJSONObject("warning") ?: JSONObject(), defaultValue.warning)
            result.attention = ColorConfig.deserialize(json.optJSONObject("attention") ?: JSONObject(), defaultValue.attention)
            return result
        }
    }
}
...
data class ColorConfig(
    ...
    companion object {
        fun deserialize(json: JSONObject, defaultValue: ColorConfig): ColorConfig {
            ...
            result.highlightColors = HighlightColorConfig.deserialize(json.optJSONObject("highlightColors") ?: JSONObject(), defaultValue.highlightColors)
            return result
        }
    }
}
...
data class ImageConfig(
    ...
    companion object {
        fun deserialize(json: JSONObject, defaultValue: ImageConfig): ImageConfig {
            ...
            result.imageSize = ImageSize.fromString(json.optString("imageSize", defaultValue.imageSize.toString()))
            return result
        }
    }
}
...
data class ActionsConfig(
    ...
    companion object {
        fun deserialize(json: JSONObject, defaultValue: ActionsConfig): ActionsConfig {
            ...
            result.actionsOrientation = ActionsOrientation.fromString(json.optString("actionsOrientation", defaultValue.actionsOrientation.toString()))
            result.actionAlignment = ActionAlignment.fromString(json.optString("actionAlignment", defaultValue.actionAlignment.toString()))
            ...
            result.showCard = ShowCardActionConfig.deserialize(json.optJSONObject("showCard") ?: JSONObject(), defaultValue.showCard)
            result.spacing = Spacing.fromString(json.optString("spacing", defaultValue.spacing.toString()))
            result.iconPlacement = IconPlacement.fromString(json.optString("iconPlacement", defaultValue.iconPlacement.toString()))
...
data class ShowCardActionConfig(
    ...
    companion object {
        fun deserialize(json: JSONObject, defaultValue: ShowCardActionConfig): ShowCardActionConfig {
            ...
            result.actionMode = ActionMode.fromString(json.optString("actionMode", defaultValue.actionMode.toString()))
            result.inlineTopMargin = json.optInt("inlineTopMargin", defaultValue.inlineTopMargin)
            result.style = ContainerStyle.fromString(json.optString("style", defaultValue.style.toString()))
            return result
        }
    }
}
...
data class TextStylesConfig(
    ...
    companion object {
        fun deserialize(json: JSONObject, defaultValue: TextStylesConfig): TextStylesConfig {
            ...
            result.heading = TextStyleConfig.deserialize(json.optJSONObject("heading") ?: JSONObject(), defaultValue.heading)
            result.columnHeader = TextStyleConfig.deserialize(json.optJSONObject("columnHeader") ?: JSONObject(), defaultValue.columnHeader)
            return result
        }
    }
}
...
data class RatingElementConfig(
    ...
    companion object {
        fun deserialize(json: JSONObject, defaultValue: RatingElementConfig): RatingElementConfig {
            ...
            result.filledStar = RatingStarConfig.deserialize(json.optJSONObject("filledStar") ?: JSONObject(), defaultValue.filledStar)
            result.emptyStar = RatingStarConfig.deserialize(json.optJSONObject("emptyStar") ?: JSONObject(), defaultValue.emptyStar)
...
data class CompoundButtonConfig(
    ...
    companion object {
        fun deserialize(json: JSONObject, defaultValue: CompoundButtonConfig): CompoundButtonConfig {
            ...
            result.badgeConfig = BadgeConfig.deserialize(json.optJSONObject("badgeConfig") ?: JSONObject(), defaultValue.badgeConfig)
            result.borderColor = json.optString("borderColor", defaultValue.borderColor)
            return result
        }
    }
...
data class TextStyleConfig(
    ...
    companion object {
        fun deserialize(json: JSONObject, defaultValue: TextStyleConfig): TextStyleConfig {
            ...
            result.color = ForegroundColor.fromString(json.optString("color", defaultValue.color.toString()))
            result.fontType = FontType.fromString(json.optString("fontType", defaultValue.fontType.toString()))
            ...
            result.weight = TextWeight.fromString(json.optString("weight", defaultValue.weight.toString()))
            return result
        }
    }
}
...
data class InputsConfig(
    ...
    companion object {
        fun deserialize(json: JSONObject, defaultValue: InputsConfig): InputsConfig {
            ...
            result.errorMessage = ErrorMessageConfig.deserialize(json.optJSONObject("errorMessage") ?: JSONObject(), defaultValue.errorMessage)
            result.label = LabelConfig.deserialize(json.optJSONObject("label") ?: JSONObject(), defaultValue.label)
            return result
        }
    }
}
...
data class LabelConfig(
    ...
    companion object {
        fun deserialize(json: JSONObject, defaultValue: LabelConfig): LabelConfig {
            ...
            result.inputSpacing = Spacing.fromString(json.optString("inputSpacing", defaultValue.inputSpacing.toString()))
            result.requiredInputs = InputLabelConfig.deserialize(json.optJSONObject("requiredInputs") ?: JSONObject(), defaultValue.requiredInputs)
            result.optionalInputs = InputLabelConfig.deserialize(json.optJSONObject("optionalInputs") ?: JSONObject(), defaultValue.optionalInputs)
            return result
        }
    }
}
